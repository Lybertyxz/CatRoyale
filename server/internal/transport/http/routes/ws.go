...
func RegisterWSRoutes(r fiber.Router, hub *ws.Hub, firebase *auth.FirebaseManager, roomManager *game.RoomManager, queue *matchmaking.Queue) {
	...
	r.Get("/ws", ws.Handler(hub, firebase, roomManager, queue))
}